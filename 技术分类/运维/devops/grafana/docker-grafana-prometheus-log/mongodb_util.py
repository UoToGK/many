...
"""
Author: xiaobin.zhu
since: 2022-07-02 08:45:00
LastAuthor: xiaobin.zhu
lastTime: 2022-07-06 10:37:38
Description: 用于本地测试
FilePath: mongodb_util
Copyright(c):
"""
# THIRD Library
# mongodb
...
class CollectionOperation:
    ...
    def __init__(self, table="policy_data"):
        """
...
def insert_data(item, content_html):
    col = CollectionOperation()
    item = dict(item)
