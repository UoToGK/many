// Created by uoto on 16/3/29.
import app from "../../app";
/// <reference path="./PagingResult.d.ts"/>
/// <reference path="./PagingOption.d.ts"/>
/**
 * 分页
 * @examples
 *   html:
...
app.directive("remotePaging", function () {
    ...
    return {
        templateUrl: `${__dirname}/paging.html`,
        scope: {
            option: "="//配置对象 {Paging}
        },
            ...
            scope.goToPage = function (page, reload) {//to page data
                ...
                option.resource[option.method](option.invokeParam, data,
                    function (result:PagingResult) {
                        option.currentPage = result.current-1;
